            ...
            <div className="container mt-5 p-3">
                ...
                <div className="row">
                    <div className="col-md-4 col-lg-4 text-center">
                        <img src={'https://picsum.photos/id/244/500/500'} alt="no image" className='img-fluid img-thumbnail' />
                    </div>
                            ...
                            <div className="col-md-6 col-lg-6">
                                <ul className="list-group">
                                    <li className="list-group-item">
                                        ...
                                        <strong>Email</strong>
                                        <span className="text-success float-end">ak2184439@gmail.com</span>
                                    </li>
                                    <li className="list-group-item">
                                        <i className="b bi-phone-fill me-2"></i>
                                        <strong>Mobile</strong>
                                        <span className="text-success float-end">+91-7305764764</span>
                                    </li>
                                    <li className="list-group-item">
                                    ...
                                    <li className="list-group-item">
                                        ...
                                        <strong>City</strong>
                                        <span className="text-success float-end">Chennai</span>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-md-6 col-lg-6">
                                <ul className="list-group">
                                    <li className="list-group-item">
                                        ...
                                        <span className="text-success float-end">MCA</span>
                                    </li>
                                    <li className="list-group-item">
